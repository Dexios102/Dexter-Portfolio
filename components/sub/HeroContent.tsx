...
const HeroContent = () => {
  return (
    <motion.div
      initial="hidden"
      animate="visible"
      className="flex flex-row items-center justify-center px-20 mt-40
    w-full z-[20]"
    >
      <div
      ...
      >
        ...
        >
          I&apos;m a Fresh Graduate/Full Stack Developer with experience in
          Website and Software Development, with a passion for creating web
          apps.
        </motion.p>
        <motion.a
